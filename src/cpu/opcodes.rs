...
const OPCODES: [fn(&mut Cpu) -> u8; 256] = [
    //    0x00,  0x01,    0x02,   0x03,    0x04,    0x05,   0x06,   0x07,   0x08,   0x09,   0x0A,   0x0B,    0x0C,    0x0D,   0x0E,   0x0F
          ...
          todo,  ld_11,  ld_12, inc_13,  inc_14,  dec_15,  ld_16,   todo,  jr_18, add_19,  ld_1a, dec_1b,  inc_1c,  dec_1d,  ld_1e,   todo, //0x01
         jr_20,  ld_21,  ld_22, inc_23,  inc_24,  dec_25,  ld_26,   todo,  jr_28, add_29,  ld_2a, dec_2b,  inc_2c,  dec_2d,  ld_2e,   todo, //0x02
         jr_30,  ld_31,  ld_32, inc_33,  inc_34,  dec_35,  ld_36,   todo,  jr_38, add_39,  ld_3a, dec_3b,  inc_3c,  dec_3d,  ld_3e,   todo, //0x03
        ...
        ret_c0, pop_c1,  jp_c2,  jp_c3, call_c4, push_c5, add_c6, rst_c7, ret_c8, ret_c9,  jp_ca,   todo, call_cc, call_cd, adc_ce, rst_cf, //0x0C
        ret_d0, pop_d1,  jp_d2,   todo, call_d4, push_d5, sub_d6, rst_d7, ret_d8,   todo,  jp_da,   todo, call_dc,    todo, sbc_de, rst_df, //0x0D
         ld_e0, pop_e1,  ld_e2,   todo,    todo, push_e5, and_e6, rst_e7, add_e8,  jp_e9,  ld_ea,   todo,    todo,    todo, xor_ee, rst_ef, //0x0E
         ld_f0, pop_f1,  ld_f2,   todo,    todo, push_f5,  or_f6, rst_f7,  ld_f8,  ld_f9,  ld_fa,   todo,    todo,    todo,  cp_fe, rst_ff, //0x0F
];
